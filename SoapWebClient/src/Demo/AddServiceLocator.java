...
public class AddServiceLocator extends org.apache.axis.client.Service implements Demo.AddService {
    ...
    private java.lang.String Add_address = "http://localhost:8080/SoapWeb/services/Add";
    ...
    public Demo.Add getAdd() throws javax.xml.rpc.ServiceException {
    ...
    public Demo.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Demo.AddSoapBindingStub _stub = new Demo.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Demo.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                Demo.AddSoapBindingStub _stub = new Demo.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Demo", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Demo", "Add"));
        }
